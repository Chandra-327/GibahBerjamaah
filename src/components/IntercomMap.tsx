...
import { MotorcycleCockpitHUD } from './MotorcycleCockpitHUD';
...
export const IntercomMap: React.FC<IntercomMapProps> = ({
  ...
  const createRiderIcon = (
    ...
    const speedText = speed !== null && speed > 2 ? `${Math.round(speed)} km/h` : '';
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Motorcycle Cockpit HUD (Klinometer Kiri/Kanan, Tanjakan/Turunan, Spidometer Bawaan Motor, Trip Resettable, Draggable & Resizable) */}
      <MotorcycleCockpitHUD
        rawSpeedKmh={mySpeed}
        myCoords={myCoords}
        myHeading={myHeading}
      />
